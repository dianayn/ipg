...
let studentLibraryBooks = students.map { (student) -> [String] in
    student.libraryBooks
}
print(studentLibraryBooks)

let studentLibraryBooks2 = students.flatMap { $0.libraryBooks }
print(studentLibraryBooks2)
...
//let studentHasPet = students.compactMap { (student) -> String? in
//    student.pet
//}
